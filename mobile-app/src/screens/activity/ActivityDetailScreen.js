...
const styles = StyleSheet.create({
    ...
    bigIcon: {
        ...
        ...Platform.select({ ios: { shadowColor: COLORS.accent, shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.25, shadowRadius: 20 } }),
    },
    ...
    intBadge: { paddingHorizontal: 18, paddingVertical: 8, borderRadius: 22, borderWidth: 1, marginBottom: 32 },
    ...
    deleteBtn: {
        ...
        paddingVertical: 15, borderRadius: 16, borderWidth: 1, borderColor: COLORS.danger + '40',
