...
const styles = StyleSheet.create({
    ...
    avatarLarge: {
        ...
        marginBottom: 16, borderWidth: 3, borderColor: COLORS.accentGlowMed,
        ...Platform.select({
            ios: { shadowColor: COLORS.accent, shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.40, shadowRadius: 20 },
    ...
    menuIcon: { width: 40, height: 40, borderRadius: 14, justifyContent: 'center', alignItems: 'center', marginRight: 14 },
    menuLabel: { color: COLORS.white, fontSize: 16, fontWeight: '600' },
    logoutBtn: {
        flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8,
        borderWidth: 1, borderColor: COLORS.danger + '40', borderRadius: 16, paddingVertical: 15,
        backgroundColor: COLORS.danger + '08',
    },
    logoutText: { color: COLORS.danger, fontWeight: '700', fontSize: 16 },
    bmiCard: { marginBottom: 20, padding: 20 },
    bmiHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 20, gap: 12 },
    bmiIconBox: { width: 38, height: 38, borderRadius: 12, backgroundColor: COLORS.accent + '15', justifyContent: 'center', alignItems: 'center' },
    ...
    bmiStats: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.03)', padding: 12, borderRadius: 14, borderWidth: 1, borderColor: COLORS.glassBorder },
